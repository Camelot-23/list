...
#include "qn_audio_source_mixer.h"
...
class QINIU_EXPORT_DLL QNMicrophoneAudioTrack
 ...
 public:
   ...
   * 获取 PCM 数据混音对象实例
   *
   * @param listener PCM 混音回调监听
   * @return QNAudioSourceMixer 实例对象
   */
  virtual QNAudioSourceMixer* CreateAudioSourceMixer(
      QNAudioSourceMixerListener* listener) = 0;

  /**
   * 释放 PCM 数据混音对象实例
   *
   * @param mixer QNAudioSourceMixer 实例对象
   */
  virtual void DestroyAudioSourceMixer(QNAudioSourceMixer* mixer) = 0;
